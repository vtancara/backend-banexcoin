...
export class InitSchema1745569996940 implements MigrationInterface {
    name = 'InitSchema1745569996940'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "transaccion" ("id" SERIAL NOT NULL, "cuenta_origen" integer NOT NULL, "cuenta_destino" integer NOT NULL, "monto" numeric(10,2) NOT NULL, "fechaHora" TIMESTAMP NOT NULL, CONSTRAINT "PK_1d7fb1e642fb44d52a2fce77fc6" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "comision" ("id" SERIAL NOT NULL, "id_transaccion" integer NOT NULL, "monto" numeric(10,2) NOT NULL, "fechaHora" TIMESTAMP NOT NULL, "id_cuenta_beneficiaria" integer NOT NULL, CONSTRAINT "PK_b131d9949148c5aa6d80795652a" PRIMARY KEY ("id"))`);
