...
export class InitSchema1745519099119 implements MigrationInterface {
    name = 'InitSchema1745519099119'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "contacto" ("id" SERIAL NOT NULL, "fecha" date NOT NULL, "id_usuario" integer NOT NULL, "id_contacto" integer NOT NULL, CONSTRAINT "PK_fcab8128cce0aac92da26cf1883" PRIMARY KEY ("id"))`);
